"""
Django settings for OpenFoodFacts_project project.
...
SECRET_KEY = 'hxeaar@145hb+^dt_!b8g4%@i=5z0@071wo5&-6yva24$fgurp'
...
ROOT_URLCONF = 'OpenFoodFacts_project.urls'
...
WSGI_APPLICATION = 'OpenFoodFacts_project.wsgi.application'
